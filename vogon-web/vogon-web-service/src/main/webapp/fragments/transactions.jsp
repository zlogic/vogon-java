		...
		<div class="panel-body">
			...
			<div infinite-scroll="transactionsService.nextPage()" infinite-scroll-disabled="transactionsService.loadingNextPage">
				<table class="table table-hover">
					...
					<tbody ng-repeat="transaction in transactionsService.transactions">
						<tr ng-class="{danger:!transactionsService.isAmountOk(transaction)}" ng-switch on="editingTransaction == transaction">
							...
							<td ng-switch-when="true" colspan="6">
								<div ng-controller="TransactionEditorController" ng-include="'fragments/transactioneditor.fragment'" ng-init="transaction = transaction" ng-view></div>
							</td>
						</tr>
